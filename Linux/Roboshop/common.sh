...
print "setup systemd"
sed -i -e "s/MONGO_DNSNAME/mongodb.roboshop.internal/"  -e "s/MONGO_ENDPOINT/mongodb.roboshop.internal/" -e "s/REDIS_ENDPOINT/redis.roboshop.internal/" "s/CATALOGUE_ENDPOINT/catalogue.roboshop.internal/" /home/roboshop/${component}/systemd.service  && mv /home/roboshop/${component}/systemd.service /etc/systemd/system/${component}.service
status_check $?
